      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <?php if ($patient): ?>
            ...
            <div class="card" style="padding: 20px; background: #fff; border-radius: 8px; margin-top: 20px;">
              <h3 style="margin-bottom: 20px; font-weight: 500;">Patient: <?php echo htmlentities($patient->firstname . ' ' . $patient->surname); ?></h3>
                        ...
                        <tbody>
                          <?php foreach ($appointments as $app): ?>
                            <tr>
                              ...
                              <td><span
                                  class="status-badge status-<?php echo strtolower(htmlentities($app['status'])); ?>"><?php echo htmlentities($app['status']); ?></span>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
                        ...
                        <tbody>
                          <?php foreach ($serviceSchedules as $s): ?>
                            <tr>
                              ...
                              <td><span
                                  class="status-badge status-<?php echo strtolower(htmlentities($s['sched_status'])); ?>"><?php echo htmlentities($s['sched_status']); ?></span>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
