...
if (strlen($_SESSION['sturecmsaid']) == 0) {
    ...
    $total_pages_sql = "SELECT COUNT(*) FROM tblappointment";
    if (!empty($where_clauses)) {
    ...
    $sql_appointments .= " ORDER BY date DESC, start_time DESC LIMIT $offset, $no_of_records_per_page";
                ...
                <div class="content-wrapper">
                    <div class="container">
                        ...
                        <div class="patient-list-card" id="appointment-table-container">
                            <h2 class="section-title">Consultation Appointments (<?php echo $total_rows; ?>)
                            </h2>
