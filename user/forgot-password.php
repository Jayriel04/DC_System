...
if(isset($_POST['submit'])) {
  ...
  if($query->rowCount() > 0) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'canoniokevin@gmail.com'; // SMTP username
        $mail->Password   = 'qfkr wesz vhkm tydc'; // SMTP password or App Password
        ...
        ';
        $mail->AltBody = 'Your One-Time Password (OTP) for resetting your password is: ' . $otp . '. It is valid for 5 minutes. If you did not request this, please ignore this email.';
