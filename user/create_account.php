                        ...
                        <div class="auth-form-light text-left p-5">
                            ...
                            <form class="pt-3" method="post" name="register">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="firstname" class="form-control form-control-lg" placeholder="Firstname" required name="firstname">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" id="password" class="form-control form-control-lg" placeholder="Password" required name="password">
                                </div>
                                <div class="form-group">
                                    <label for="confirm_password">Confirm Password</label>
                                    <input type="password" id="confirm_password" class="form-control form-control-lg" placeholder="Confirm Password" required name="confirm_password">
                                </div>
                                <div class="mt-3">
