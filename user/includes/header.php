    ...
    if ($query->rowCount() > 0) {
        foreach ($results as $row) { ?>
            <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
                <h5 class="mb-0 font-weight-medium d-none d-lg-flex"><?php echo htmlentities($row->firstname . ' ' . $row->surname); ?>, welcome to the dashboard!</h5>
                <ul class="navbar-nav navbar-nav-right ml-auto">
                    <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
                        <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                            <img class="img-xs rounded-circle ml-2" src="<?php echo htmlentities($row->Image); ?>" alt="Profile image"> 
                            <span class="font-weight-normal"><?php echo htmlentities($row->firstname); ?></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                            <div class="dropdown-header text-center">
                                <img class="img-md rounded-circle" src="<?php echo htmlentities($row->Image); ?>" alt="Profile image">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
            ...
            <ul class="navbar-nav navbar-nav-right ml-auto">
                <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
                    <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                        <img class="img-xs rounded-circle ml-2" src="path/to/default-profile.png" alt="Default Profile image">
                        <span class="font-weight-normal">Guest</span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                        <div class="dropdown-header text-center">
                            <img class="img-md rounded-circle" src="path/to/default-profile.png" alt="Default Profile image">
                            <p class="mb-1 mt-3">Guest</p>
                        </div>
                        <a class="dropdown-item" href="login.php"><i class="dropdown-item-icon icon-user text-primary"></i> Login</a>
                    </div>
                </li>
            </ul>
        </div>
